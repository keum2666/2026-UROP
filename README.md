...
- [ ] 국토부 정류장 위치정보를 이용한 승차·하차 좌표 매핑
  - `06_stop_coordinates_mapping.py`를 작성했으며, 국토부 위치정보 CSV 경로를 확인한 뒤 실행하면 됩니다.
...
| `Desktop/Gachon/3-2/UROP/06_stop_coordinates_mapping.py` | 국토부 정류장 위치정보를 이용한 승차·하차 위도·경도 매핑 |
